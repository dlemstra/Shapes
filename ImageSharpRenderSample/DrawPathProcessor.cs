...
namespace ImageSharp.Drawing.Processors
{
        ...
        where TColor : struct, IPackedPixel, IEquatable<TColor>
    {
        ...
        public DrawPathProcessor(IPen<TColor> pen, IShape shape, GraphicsOptions options)
            : this(pen, shape.Paths.ToArray(), options)
        {
        }
        ...
        public DrawPathProcessor(IPen<TColor> pen, IPath[] paths, GraphicsOptions options)
        {
            ...
            else
            {
                ...
                var shaperRect = paths[0].Bounds;
                this.region = new RectangleF(shaperRect.X, shaperRect.Y, shaperRect.Size.Width, shaperRect.Size.Height);
            }
        }
